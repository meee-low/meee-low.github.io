...
export function recursiveFlattenAndSerialize(obj: any) {
  return obj;
}

export function flattenedToQuery(flattened: Object): string {
  return JSON.stringify(flattened);
}

export function deserializeObject(queryString: string): Object {
